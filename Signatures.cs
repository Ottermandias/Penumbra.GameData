...
public static class Sigs
{
    ...
    public const string BaseClipGetTargetGameObject = "E8 ?? ?? ?? ?? 48 85 C0 0F 84 ?? ?? ?? ?? 8B 8F ?? ?? ?? ?? 83 E9";
    public const string BaseClipGetSourceObjectIndex = "E8 ?? ?? ?? ?? 48 8B CF 44 8B E0";
    public const string BaseClipCanQuerySourceObjectIndex = "E8 ?? ?? ?? ?? 44 0F B6 F8 49 8B CE";
