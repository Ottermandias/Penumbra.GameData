...
public static class Sigs
{
    ...
    public const string SetupTopModelAttributes = "E8 ?? ?? ?? ?? 48 8B 87 ?? ?? ?? ?? 44 0F B6 7C 24";

    public const string SetupLegModelAttributes =
        "E8 ?? ?? ?? ?? 48 8D 54 24 ?? 48 8B CF E8 ?? ?? ?? ?? 48 8D 54 24 ?? 48 8B CF E8 ?? ?? ?? ?? 48 8B 87";

    public const string SetupHandModelAttributes      = "40 53 57 41 56 48 83 EC 20 48 8B 81 ?? ?? ?? ?? 48 8B FA";
    public const string SetupFootModelAttributes      = "40 53 56 41 56 48 83 EC ?? 48 8B 99 ?? ?? ?? ?? 48 8B F2";
    public const string SetupEarModelAttributes       = "E8 ?? ?? ?? ?? 48 8B 87 ?? ?? ?? ?? 0F B6 6C 24";
    public const string SetupFaceModelAttributes      = "E8 ?? ?? ?? ?? 48 8B 87 ?? ?? ?? ?? 48 8B 50 ?? 48 85 D2";
    public const string SetupHairModelAttributes      = "40 53 55 56 48 83 EC ?? 48 8B 81 ?? ?? ?? ?? 48 8B EA";
    public const string SetupConnectorModelAttributes = "E8 ?? ?? ?? ?? 41 0F B6 C6 4C 8D 44 24";
