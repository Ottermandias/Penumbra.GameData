...
public sealed class IdentificationListEquipment(IDalamudPluginInterface pi, LunaLogger log, IDataManager gameData, ItemsByType items)
    : KeyList<PseudoEquipItem>(pi, log, "EquipmentIdentification", gameData.Language, Version.IdentificationListEquipment, () => CreateEquipmentList(items), ToKey, ValidKey,
