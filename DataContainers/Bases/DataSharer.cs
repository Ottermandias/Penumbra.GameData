...
public abstract class DataSharer<T>(IDalamudPluginInterface pluginInterface, LunaLogger log, string name, ClientLanguage language, int version)
    : IDisposable, IAsyncDataContainer
{
    ...
    protected DataSharer(IDalamudPluginInterface pluginInterface, LunaLogger log, string name, ClientLanguage language, int version,
