...
public sealed class ItemsSecondaryModel(IDalamudPluginInterface pi, LunaLogger log, IDataManager gameData, ItemsByType items)
    : ItemDictionary(pi, log, "ItemDictSecondary", gameData.Language, Version.ItemsSecondaryModel, () => CreateOffhands(items), items.Awaiter)
{
